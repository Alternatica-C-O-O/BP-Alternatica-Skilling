...
public class AsignacionHorarioServiceImpl implements AsignacionHorarioService {
	...
	return AsignacionHorario.builder().diaSemana(dto.diaSemana()).horaInicio(dto.horaInicio())
		.horaFin(dto.horaFin()).tipoAsignacion(dto.tipoAsignacion()).usuariosId(dto.usuariosId())
		.espacioFisicoId(dto.espacioFisicoId()).plataformaVirtualId(dto.plataformaVirtualId())
		.cursoOfertadoId(dto.cursoOfertadoId()).periodoAcademicoId(dto.periodoAcademicoId()).build();
    }

    private AsignacionHorarioResponseDTO toAsignacionHorarioResponseDTO(AsignacionHorario entity) {
	return new AsignacionHorarioResponseDTO(entity.getId(), entity.getEspacioFisicoId(), "Nombre Espacio",
		entity.getPlataformaVirtualId(), "Nombre Plataforma", entity.getPeriodoAcademicoId(), "Nombre Periodo",
		entity.getTipoAsignacion(), entity.getHoraInicio(), entity.getHoraFin(), entity.getDiaSemana());
    }
}
